...
namespace Fituska.DAL.Migrations
{
    ...
    [Migration("20211026085735_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fituska.DAL.Entities.PhotoEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Fituska.DAL.Entities.UserEntity", b =>
                {
                    b.HasOne("Fituska.DAL.Entities.AnswerEntity", null)
                        .WithMany("UsersSawQuestion")
                        .HasForeignKey("AnswerEntityId");

                    b.HasOne("Fituska.DAL.Entities.PhotoEntity", "Photo")
                        .WithMany()
